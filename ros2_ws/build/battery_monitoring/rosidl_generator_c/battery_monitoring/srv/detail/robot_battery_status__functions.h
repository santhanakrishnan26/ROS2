...
#ifndef BATTERY_MONITORING__SRV__DETAIL__ROBOT_BATTERY_STATUS__FUNCTIONS_H_
#define BATTERY_MONITORING__SRV__DETAIL__ROBOT_BATTERY_STATUS__FUNCTIONS_H_
...
#include "battery_monitoring/msg/rosidl_generator_c__visibility_control.h"

#include "battery_monitoring/srv/detail/robot_battery_status__struct.h"

/// Initialize srv/RobotBatteryStatus message.
/**
...
/// Create srv/RobotBatteryStatus message.
/**
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * battery_monitoring__srv__RobotBatteryStatus_Request__init().
...
/// Destroy srv/RobotBatteryStatus message.
/**
 * It calls
 * battery_monitoring__srv__RobotBatteryStatus_Request__fini()
...
/// Initialize array of srv/RobotBatteryStatus messages.
/**
...
/// Finalize array of srv/RobotBatteryStatus messages.
/**
 * It calls
 * battery_monitoring__srv__RobotBatteryStatus_Request__fini()
...
/// Create array of srv/RobotBatteryStatus messages.
/**
 * It allocates the memory for the array and calls
 * battery_monitoring__srv__RobotBatteryStatus_Request__Sequence__init().
 * \param[in] size The size / capacity of the array.
...
/// Destroy array of srv/RobotBatteryStatus messages.
/**
 * It calls
 * battery_monitoring__srv__RobotBatteryStatus_Request__Sequence__fini()
 * on the array,
 ...
 * It allocates the memory for the message, sets the memory to zero, and
 * calls
 * battery_monitoring__srv__RobotBatteryStatus_Response__init().
 * \return The pointer to the initialized message if successful,
 * otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_battery_monitoring
...
/**
 * It calls
 * battery_monitoring__srv__RobotBatteryStatus_Response__fini()
 * and frees the memory of the message.
 * \param[in,out] msg The allocated message pointer.
 */
ROSIDL_GENERATOR_C_PUBLIC_battery_monitoring
...
/**
 * It allocates the memory for the array and calls
 * battery_monitoring__srv__RobotBatteryStatus_Response__Sequence__init().
 * \param[in] size The size / capacity of the array.
 * \return The pointer to the initialized array if successful, otherwise NULL
 */
ROSIDL_GENERATOR_C_PUBLIC_battery_monitoring
...
/**
 * It calls
 * battery_monitoring__srv__RobotBatteryStatus_Response__Sequence__fini()
 * on the array,
 * and frees the memory of the array.
 * \param[in,out] array The initialized array pointer.
 */
...
#endif  // BATTERY_MONITORING__SRV__DETAIL__ROBOT_BATTERY_STATUS__FUNCTIONS_H_
